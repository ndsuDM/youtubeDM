...
dd<-dd+1
graph_from_edgelist(dd, directed = TRUE)
gg <- graph_from_edgelist(cbind(dd), directed = true)
#E(gg)$weight <- 1 
...
print(length(pruned))
mg<-MCL::mcl(as_adjacency_matrix(gg), addLoops = TRUE)
print(mg)